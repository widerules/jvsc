...
public class ClarinetActivity extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		mAudioOutput = new AudioTrack(AudioManager.STREAM_MUSIC, fs, AudioFormat.CHANNEL_CONFIGURATION_MONO, AudioFormat.ENCODING_PCM_16BIT, 2 * smpCnt, AudioTrack.MODE_STREAM);
