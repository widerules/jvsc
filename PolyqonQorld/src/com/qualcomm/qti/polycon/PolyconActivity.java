...
public class PolyconActivity extends Activity implements Camera.PreviewCallback 
{
	...
	{
		Intent intent = new Intent(c, PolyconActivity.class);
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		// Create our Preview view and set it as the content of our activity.           
			    ...
			    mPreview = new CameraSurfacePreview(PolyconActivity.this, cameraObj, faceProc);
			    preview.removeView(mPreview);
			    preview = (FrameLayout) findViewById(R.id.camera_preview);
			    preview.addView(mPreview);
			    cameraObj.setPreviewCallback(PolyconActivity.this);    
            ...
            public boolean onTouch(View v, MotionEvent event)
            {
                ...
                case MotionEvent.ACTION_DOWN:
                	...
                	if(!info)
                	{
                		...
                		if(PolyconActivity.this.getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE)
                		{
...
//	}
	...
	public void onPreviewFrame(byte[] data, Camera arg1) {
		...
		int dRotation = 1;//display.getRotation();
